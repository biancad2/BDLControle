...
export default class EditManutencao extends Component {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        ...
        api.get('/manutencoes/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
                id_veiculo: response.data[0].id_veiculo,
                tipo_manut: response.data[0].tipo_manut,
                servico: response.data[0].servico,   
                causa: response.data[0].causa,
                valor_manut: response.data[0].valor_manut,
    ...
    onSubmit(e) {
        ...
        api.put('/manutencoes/' + this.props.match.params.id, obj)
            .then(res => console.log(res.data));

        this.props.history.push('/manutencoes');
    }
    logOut(e) {
        e.preventDefault()
