...
export default class EditMulta extends Component {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        api.get('/multas/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
                id_multa: response.data[0].id_multa,
                id_motorista: response.data[0].id_motorista,
                id_veiculo: response.data[0].id_veiculo,   
                ds_infracao: response.data[0].ds_infracao,
                ds_gravidade: response.data[0].ds_gravidade,
                qt_preco: response.data[0].qt_preco,
                dt_infracao:response.data[0].dt_infracao,
                data: new Date(response.data[0].dt_infracao)
            }
            );
    ...
    onSubmit(e) {
        ...
        api.put('/multas/' + this.props.match.params.id, obj)
