...
export default class EditEstoque extends Component {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        ...
        api.get('/estoques/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
                nm_produto: response.data[0].nm_produto,
                ds_produto: response.data[0].ds_produto,
                qt_produto: response.data[0].qt_produto   
            }
            );
    ...
    onSubmit(e) {
        ...
        api.put('/estoques/' + this.props.match.params.id, obj)
            .then(res => console.log(res.data));

        this.props.history.push('/estoques');
    }
    logOut(e) {
        e.preventDefault()
