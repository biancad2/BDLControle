...
export default class CreateLocacao extends Component {
    constructor(props) {
        super(props);
    ...
    onChangeDataDevolvida(e) {
        this.setState({
            dt_devolvida: e.target.value
        })
    }
    onChangeVeiculo(e) {
        this.setState({
                       ...
                       onChange={this.onChangeVeiculo}>
                           ...
                           { this.state.veiculos.map(veiculo =>(
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="datetime-local" class="form-control" id="inputDataLocacao" placeholder="Ex: Rua Aleatoria, nº 0" required value={this.state.dt_alugada}
